...
public class User extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            Service userSer = new RegisterService();
            Users admin = null;
            ...
            String encPass = Encryption.GenerateHash(password);
            admin = new Users(name, surname, phone, email, encPass);
            
            userSer.addAdmin(admin);
